...
export default {
  ...
  methods: {
    ...
    saveProduct() {
      // Create an Axios instance with the CSRF token included in the headers
      ...
      // Use the CSRF Axios instance to make the POST request
      csrfAxios.post('/product/create/', product)
        .then(response => {
  ...
  mounted() {
    this.csrfToken = document.querySelector('#csrf-form input[name="csrfmiddlewaretoken"]').value;
